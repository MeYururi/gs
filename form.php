...
function formCheck() {
  ...
  <body>
    ...
    <div class="container">
      ...
      <form class="pastplan" method = "post" target = "questionnaire.html">
        <span class="formdesc" >過去のプランをレビューする</span>

        <ul class="selectplan nav nav-pills nav-stacked" requied>
          <li>
            <!--プランの開始時刻をデータベースから取得して表示-->
            <label>プラン1 <span class="spotstarttime" style = "font-size:90%;" >(2015/04/02 10:30)</span></label>
            <input name="plan" type= "radio" id="plan1" value = "1">
            <br>
            <!--該当プランのタイムラインへのリンク-->
            <!--オンマウス時とかに詳細を出せたらいいかも-->

            <div class="plan-images">
              <a class="nav-href" data-toggle="tooltipplan" data-placement="bottom" title="SpotName1 10:30"> <!--ここに取得したスポット名,時刻を入れる--><img src="img/food (1).jpg"></img></a>
              <a class="nav-href" data-toggle="tooltipplan" data-placement="bottom" title="SpotName2 13:30"> <!--ここに取得したスポット名,時刻を入れる--> <img src="img/food (2).jpg"></img></a>
              <a class="nav-href" data-toggle="tooltipplan" data-placement="bottom" title="SpotName3 14:30"> <!--ここに取得したスポット名,時刻を入れる--><img src="img/food (3).jpg"></img></a>
              <a class="nav-href" data-toggle="tooltipplan" data-placement="bottom" title="SpotName4 16:00"> <!--ここに取得したスポット名,時刻を入れる--><img src="img/food (4).jpg"></img></a>
              <a class="nav-href" data-toggle="tooltipplan" data-placement="bottom" title="SpotName5 18:00"> <!--ここに取得したスポット名,時刻を入れる--><img src="img/food (5).jpg"></img></a>
            </div><!-- plan-images-->
          </li>

          <li>
            <label>プラン2</label>
            <input name="plan" type= "radio" id="plan2" value = "2">
            <br>
            <!--該当プランのタイムラインへのリンク-->
            <!--オンマウス時とかに詳細を出せたらいいかも-->

            <div class="plan-images">
              <span href=""><img src="img/food (1).jpg"/></span>
              <span href=""><img src="img/food (2).jpg"/></span>
              <span href=""><img src="img/food (3).jpg"/></span>
              <span href=""><img src="img/food (4).jpg"/></span>
              <span href=""><img src="img/food (5).jpg"/></span>
        ...
        <br>
        <input type="submit"  class="btn btn-salmon" value="Feedback" />  
